package com.android.practice.library.custom.cardstatck.cardstack;
...
import com.android.practice.library.CoreApp;
import com.android.practice.library.R;
import com.android.practice.library.custom.cardstatck.animation.RelativeLayoutParamsEvaluator;
        ...
        for (View v : mCardCollection) {
            ...
            */
            ...
            if (index == 0)// setting 0 used to add different layout shadow...
                v.setBackground(CoreApp.getInstance().getResources().getDrawable(R.drawable.card_stack_bg_shadow3));
            else if (index == 1)
                v.setBackground(CoreApp.getInstance().getResources().getDrawable(R.drawable.card_stack_bg_shadow2));
            else if (index == 2)
                v.setBackground(CoreApp.getInstance().getResources().getDrawable(R.drawable.card_stack_bg_shadow));
        }
    }
